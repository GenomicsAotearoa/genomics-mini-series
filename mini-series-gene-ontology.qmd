...
This is an extension on our RNA-seq workshop, which runs through GOseq analysis but using a supported organism yeast [RNAseq workshop link here](https://genomicsaotearoa.github.io/RNA-seq-data-analysis-workflow/episode_5.html)
...
1. **DGE list**: A character vector of all the differentially expressed gene (DEGs) IDs. You will need to make two character vectors of DEGs: one for upregulated genes and one for downregulated genes.
2. **Background genes**: A character vector of the background gene list.   
3. **Gene ontologies**: A gene annotation file that maps gene identifiers to GO terms.   
4. **Gene lengths**: A gene length file to account for gene length bias.   
...
ccdc51	        .
tma7	        .
LOC117815572	GO:0005615,GO:0030280,GO:0031424,GO:0045095,GO:0045095,GO:0045109
LOC117818779	GO:0005615,GO:0030280,GO:0031424,GO:0045095,GO:0045095,GO:0045109
LOC117818773	GO:0005615,GO:0030280,GO:0031424,GO:0045095,GO:0045095,GO:0045109
LOC117832729	GO:0005615,GO:0030280,GO:0031424,GO:0045095,GO:0045095,GO:0045109
...
See the Gene Onotology website for more information about getting GO annotations [https://geneontology.org/docs/download-go-annotations/](https://geneontology.org/docs/download-go-annotations/)
...
library(ggplot2)
goout_MT_UP_over %>% 
  filter(!is.na(ontology)) %>% # filter out any NAs
  ...
  labs(title="Top 5 overrepresented GO terms in genes upregulated in MT, vs F",x = "GO Term", y = "GeneRatio", fill = "-log10(p-value)") + 
  theme_classic()
```